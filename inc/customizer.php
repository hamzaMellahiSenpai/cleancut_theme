<?php
	function cleancut_customize_register($wp_customize){
		...
		// Linkedin URL Setting
		 ...
		 // BOOTOM Banner Section
		 $wp_customize->add_section('banner',$args);
		 $args = [
		 ...
		 $wp_customize->add_control('banner_heading', array(
		   'label'    => __('Banner Heading', 'cleancut'),
		   'section'  => 'banner',
		   'priority' =>170,
		 ));

		 // MISC ANIMATION
		 $wp_customize->add_section('misc', $misc_args);
		 $misc_args = [
		 ...
		 // MISC ANIMATION SETTING
		 $wp_customize->add_setting('animation', array(
		 	"default" => "1"
		 ));

		 // MISC ANIMATION Control
		 $wp_customize->add_control(new WP_Customize_Control($wp_customize , "animation", $animation_args));
		 $animation_args = [
